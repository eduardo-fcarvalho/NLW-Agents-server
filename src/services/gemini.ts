...
export async function generateAnswer(
  ...
  const prompt = `
    Com base no text fornecido abaixo como contexto, responda a pergunta de forma clara e precisa em português do Brasil.
    ...
    INSTRUÇÕES:
    - Use informações contidas apenas no texto enviado;
